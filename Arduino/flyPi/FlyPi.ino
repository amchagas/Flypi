...
void setup(){ 
  ...
  matrix.begin(0x70);  // pass in the address for LED Matrix
...
void loop(){ 
  ...
  if (Peltier == 1) { // GO TO LOW T
   Peltier_ON = true;
   HoldTemp(coldTemp,tempSensorPin, peltierCoolPin1,peltierCoolPin2, peltierHeatPin1, peltierHeatPin2,tempToAnalog);
  }  
  if (Peltier == 2) { // GO TO HIGH T
    Peltier_ON = true; 
    HoldTemp(hotTemp,tempSensorPin, peltierCoolPin1,peltierCoolPin2, peltierHeatPin1, peltierHeatPin2,tempToAnalog);
  }    
  ///////////////////////////////////////////////////////////////////////
...
float HoldTemp(float finalTemp,int tempSensorPin,int peltierCoolPin1,int peltierCoolPin2,int peltierHeatPin1,int peltierHeatPin2,int tempToAnalog){
